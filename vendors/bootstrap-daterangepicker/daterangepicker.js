    ...
    return a.prototype = {
        ...
        move: function() {
            ...
            switch (this.parentEl.is("body") || (a = {
                ...
                case "auto":
                    //(this.parentEl[0].scrollHeight <= 928) ? (t = this.element.offset().top + this.element.outerHeight() - a.top) : (t = this.element.offset().top - this.container.outerHeight() - a.top, i = "up");
